...
public class CryptoRSATest {
    ...
    @Test
    public void testRSA() {
        PrivateKey sk = KeyFactory.getPrivateKey(PrivateKey.RSA);
    ...
    public void testPublicKey() {
        ...
        PublicKey key = KeyFactory.getPublicKey(dictionary);
    ...
    public void testPrivateKey() {
        ...
        PrivateKey sk = KeyFactory.getPrivateKey(dictionary);
